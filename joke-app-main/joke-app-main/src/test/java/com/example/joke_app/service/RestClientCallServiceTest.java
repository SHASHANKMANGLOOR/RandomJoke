...
public class RestClientCallServiceTest {
    ...
    public void testRestClientStatusIsNotOk() {
        ...
        assertThrows(ServiceExcpetion.class, () -> restClientCallService.fetchJokes(8));
    }
    ...
    void testResourceAccessException() {
        ...
        assertThrows(ServiceExcpetion.class, () -> restClientCallService.fetchJokes(5));
    }
    ...
    void testRestClientCallException() {
        ...
        assertThrows(ServiceExcpetion.class, () -> restClientCallService.fetchJokes(9));
    }
    ...
    void testFetchJokeExceptionHandlerDirectly() {
        ...
        ServiceExcpetion exception = new ServiceExcpetion("Invalid!!!");
